...
disp('training data.')
disp(' ')
disp('As this can take more than an hour, you have the option to load a')
disp('previously trained network.')
disp(' ')
s = input('Load a trained network (y/n)? ', 's');
